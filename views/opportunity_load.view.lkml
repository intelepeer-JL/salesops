# The name of this view in Looker is "Opportunity Load"
view: opportunity_load {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: `test-and-poc.salesops_sf.Opportunity_load`
    ;;
  drill_fields: [id]
  ...
  dimension: questions_comments__c {
    type: string
    sql: ${TABLE}.Questions_Comments__c ;;
  }
  ...
  dimension: strategic_partner__c {
    type: string
    sql: ${TABLE}.Strategic_Partner__c ;;
  }
  ...
  measure: count {
    type: count
    drill_fields: [id, stage_name, name, account.name, account.i2_account_id__c]
  }
}
