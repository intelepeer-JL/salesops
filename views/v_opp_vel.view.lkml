# The name of this view in Looker is "V Opp Vel"
view: v_opp_vel {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: `test-and-poc.salesops_sf.v_opp_vel`
    ;;
  ...
  dimension: correctedduartion {
    type: number
    sql: ${TABLE}.correctedduartion ;;
  }
  ...
  measure: total_correctedduartion {
    type: sum
    hidden: yes
    sql: ${correctedduartion} ;;
  }

  measure: average_correctedduartion {
    type: average
    hidden: yes
    sql: ${correctedduartion} ;;
  }
